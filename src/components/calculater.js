            ...
            <div className="container my-2">
                <div className="row">
                    <div className="col-12">
                        <h1 className="display-6 fw-bolder text-center text-primary"> Simple Calculator</h1>
                        <hr />
                    </div>
                </div>
                        ...
                        <div className="card mb-3 pt-3 shadow">
                            <div className="card-body text-primary">
                                ...
                                <div className="row mt-2">
                                    ...
                                    <div className="col-3">
                                        <button className="btn btn-light text-primary shadow p-4 fs-4" value={"00"} onClick={(e) => setVal(val + e.target.value)}>00</button>
                                    </div>
                                    <div className="col-3">
                                        <button className="btn btn-light text-primary shadow p-4 fs-4 bg-dark" value={"="} onClick={() => calculate()}>=</button>
                                    </div>
                                </div>
                            </div>
                        </div>
